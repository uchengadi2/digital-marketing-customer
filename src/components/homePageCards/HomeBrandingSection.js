...
import background from "./../../assets/images/headers/branding.png";
...
export default function HomeBrandingSection(props) {
        ...
        <Card className={classes.root} disableRipple>
          ...
          <Grid container direction="row">
            ...
            <Grid item style={{ width: "46.19%", border: "1px dotted grey" }}>
              <CardContent disableRipple>
                ...
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * In today's world, branding is a vital component of success
                    for organizations. It creates recognition, credibility, and
                    customer loyalty while attracting top talent and offering a
                    competitive advantage. Investing in branding ensures
                    long-term growth and sustainability, making it crucial for
                    organizations to embrace and nurture its power to achieve
                ...
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Branding is not just a superficial aspect of business; it
                    is a strategic tool that can significantly impact an
                    organization's success.
                  </ReactMarkdown>
                </Typography>
                {/* <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Sets an organization apart from competitors by creating a
                    distinct and memorable impression in consumers' minds,
                    enabling differentiation and communication of the value
                    proposition.
                  </ReactMarkdown>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Builds recognition and familiarity through consistent
                    visual elements, enhancing visibility and increasing the
                    likelihood of being chosen by customers.
                  </ReactMarkdown>
                </Typography> */}
              </CardContent>
            </Grid>
            ...
            <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              <Typography variant="h5" color="textSecondary" component="p">
                <ReactMarkdown>
                  * Branding conveys credibility, professionalism, and
                  trustworthiness, leading to customer confidence in purchasing
                  decisions and fostering positive perceptions among
                  stakeholders.
                </ReactMarkdown>
              </Typography>
              <Button
