...
import background from "./../../assets/images/headers/app.png";
...
export default function HomeWebAndAppSection(props) {
        ...
        <Card className={classes.root} disableRipple>
          ...
          <Grid container direction="row">
              ...
              <CardContent disableRipple>
                ...
                >
                  <span style={{ marginLeft: 130 }}>
                    <strong>Web & App Solutions</strong>
                  </span>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Web and app solutions are instrumental in driving the
                    digital transformation of businesses. From increased
                    accessibility and enhanced customer engagement to process
                    efficiency and data-driven decision making, the benefits are
                    extensive.
                  </ReactMarkdown>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * By leveraging these technologies, businesses can gain a
                    competitive advantage, achieve operational excellence, and
                    unlock new opportunities for growth in the digital
                    landscape.
                  </ReactMarkdown>
                </Typography>
                {/* <Typography variant="h5" color="textSecondary" component="p">
            ...
            <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              <Typography variant="h5" color="textSecondary" component="p">
                <ReactMarkdown>
                  * Embracing web and app solutions is not merely an option but
                  a necessity in today's dynamic business environment.
                </ReactMarkdown>
              </Typography>
              <Button
                component={Link}
