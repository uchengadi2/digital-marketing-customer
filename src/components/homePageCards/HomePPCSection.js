...
import background from "./../../assets/images/headers/ppc.png";
...
export default function HomePPCSection(props) {
        ...
        <Card className={classes.root} disableRipple>
          ...
          <Grid container direction="row">
              ...
              <CardContent disableRipple>
                ...
                >
                  <span style={{ marginLeft: 130 }}>
                    <strong>Pay Per Click(PPC) Management</strong>
                  </span>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Pay-per-click(PPC) advertising is an essential part of a
                    successful digital marketing strategy. It allows precise
                    audience targeting, instant visibility, measurable results,
                    and scalability.
                  </ReactMarkdown>
                </Typography>
                ...
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * By embracing PPC, businesses can reach new customers,
                    increase brand exposure, and experience transformative
                    growth. Investing in PPC today can have a significant impact
                ...
                {/* <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * First and foremost, PPC offers unparalleled targeting
                    capabilities. With PPC, you have the ability to reach your
                    ideal audience precisely at the moment they are searching
                    for products or services related to your business. By
                    leveraging keyword targeting and various demographic
                    filters, you can ensure that your ads are displayed to the
                    most relevant and qualified prospects. This laser-focused
                    approach maximizes the efficiency of your marketing budget,
                    as you only pay when a user clicks on your ad, making each
                    click a valuable opportunity to convert a lead into a
                    customer.
                  </ReactMarkdown>
                </Typography> */}
                {/* <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * On this platform, both new and old members are required to
                    sign up to fully utilise all the features on the platform
                  </ReactMarkdown>
                </Typography> */}
              </CardContent>
            </Grid>
            ...
            <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              <Typography variant="h5" color="textSecondary" component="p">
                <ReactMarkdown>
                  * Don't wait any longer; invest in PPC today and witness the
                  transformative impact it can have on your organization.
                </ReactMarkdown>
              </Typography>
              <Button
                component={Link}
