      ...
      {matchesMDUp ? (
        <Card className={classes.root} disableRipple>
          ...
          <Grid container direction="row">
            ...
            <Grid item style={{ width: "90.19%", border: "1px dotted white" }}>
                ...
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Such events include but not limited to the End of the Year
                    get together, occassional meetups, meetings, ceremonies and
                    celebration
                  </ReactMarkdown>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * The Event Page is provided to keep members abreast of all
                    events organiazed or promoted by the association. To know
                    more about both past and current events please click on the
          ...
          /> */}
            ...
            {/* <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              <Typography variant="h5" color="textSecondary" component="p">
                <ReactMarkdown>
                  * The Event Page is provided to keep members abreast of all
                  events organiazed or promoted by the association. To know more
                  about both past and current events please click on the Learn
                  More button below,
                </ReactMarkdown>
              </Typography>
              <Button
