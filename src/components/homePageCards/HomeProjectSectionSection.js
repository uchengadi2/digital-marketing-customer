...
export default function HomeProjectSectionSection(props) {
                ...
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Furthermore, individual members can also liaise with the
                    association to start a project of interest that will benefit
                    the Community, our Alma Mata and other Members alike
                  </ReactMarkdown>
                </Typography>
              </CardContent>
            </Grid>
