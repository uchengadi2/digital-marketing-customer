...
import background from "./../../assets/images/headers/website.png";
...
export default function HomeWebsiteServicesSection(props) {
        ...
        <Card className={classes.root} disableRipple>
          ...
          <Grid container direction="row">
            ...
            <Grid item style={{ width: "46.19%", border: "1px dotted grey" }}>
              <CardContent disableRipple>
                ...
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * A website is an essential asset for every organization. It
                    acts as the digital representation of your business, crucial
                    for building credibility, trust, and fostering growth.
                  </ReactMarkdown>
                </Typography>

                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * By investing in a well-designed and user-friendly website,
                    you can expand your reach, increase brand awareness,
                    generate leads, and successfully achieve your organizational
                    goals.
                  </ReactMarkdown>
                </Typography>
                <br />
                {/* <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * **Online Presence**: A website serves as your
                    organization's virtual storefront, open 24/7 to a global
                    audience. It acts as a central hub for all your online
                    activities, representing your brand, products, and services.
                    It allows potential customers and clients to find you
                    easily, gather information, and engage with your offerings
                    at their convenience.
                  </ReactMarkdown>
                </Typography> */}
                {/* <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * **Lead Generation and Conversion**: Your website can serve
                    as a powerful lead generation tool. By incorporating
                    strategically placed call-to-action buttons, contact forms,
                    and opt-in opportunities, you can capture valuable customer
                    information and nurture leads. Additionally, an
                    e-commerce-enabled website can facilitate seamless online
                    transactions, maximizing conversion rates and revenue
                    generation.
                  </ReactMarkdown>
                </Typography> */}
              </CardContent>
            ...
            <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              <Typography variant="h5" color="textSecondary" component="p">
                <ReactMarkdown>
                  * Don't miss out on the countless opportunities the online
                  world has to offer – establish your online presence today!
                </ReactMarkdown>
              </Typography>
              <Button
                component={Link}
            ...
            <Grid container direction="row">
              ...
              <Grid item style={{ width: "100%", border: "1px dotted grey" }}>
                <CardContent disableRipple>
                  ...
                  >
                    <ReactMarkdown>
                      Website serves as the digital face of your business,
                      fostering credibility, trust, and growth. By investing in
                      a well-designed and user-friendly website, you can expand
                      your reach, enhance brand awareness, generate leads, and
                      ultimately achieve your organizational goals
                    </ReactMarkdown>
                  </Typography>
                  <Typography variant="h5" color="textSecondary" component="p">
                    <ReactMarkdown>
