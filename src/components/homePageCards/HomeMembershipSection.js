...
export default function HomeMembershipSection(props) {
          ...
          <Grid container direction="row">
            ...
            <Grid item style={{ width: "46.19%", border: "1px dotted grey" }}>
              <CardContent disableRipple>
                ...
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * So irrespective of your year of graduation, provided that
                    you attended Adeolu Secondary School, Tolu School Complex,
                    Olodi Apapa, Lagos, you are a potential member of this great
                    association
                  </ReactMarkdown>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
            ...
            <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              <Typography variant="h5" color="textSecondary" component="p">
                <ReactMarkdown>
                  * To know more about this great association membership related
                  issues, please click the button below to learn more,
                </ReactMarkdown>
              </Typography>
              <Button
                component={Link}
