...
import background from "./../../assets/images/headers/exec.png";
...
export default function HomeExecutivesSocialMediaSection(props) {
        ...
        <Card className={classes.root} disableRipple>
          ...
          <Grid container direction="row">
              ...
              <CardContent disableRipple>
                ...
                >
                  <span style={{ marginLeft: 130 }}>
                    <strong>Executives Social Media</strong>
                  </span>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Executive social media presence is crucial for the growth
                    of a business organization. It influences brand perception,
                    enhances thought leadership, strengthens customer
                    relationships, expands networks, and provides a competitive
                    advantage.
                  </ReactMarkdown>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Encouraging executives to build their personal brand and
                    engage with the digital community unlocks numerous
                    opportunities that can elevate the organization to new
                    heights.
                  </ReactMarkdown>
                </Typography>
                <br />
            ...
            <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              <Typography variant="h5" color="textSecondary" component="p">
                <ReactMarkdown>
                  * Embrace this transformative strategy today, and witness the
                  remarkable growth and success that awaits your business.
                </ReactMarkdown>
              </Typography>
              <Button
                component={Link}
