...
import background from "./../../assets/images/headers/content.png";
...
export default function ContentAndEmailMarketingSection(props) {
        ...
        <Card className={classes.root} disableRipple>
          ...
          <Grid container direction="row">
              ...
              <CardContent disableRipple>
                ...
                >
                  <span style={{ marginLeft: 130 }}>
                    <strong>Content & Email Marketing</strong>
                  </span>
                </Typography>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * Content and email marketing are crucial for organizational
                    growth in the digital age. These strategies allow you to
                    engage your audience, attract traffic, build relationships,
                    measure results, and enhance brand visibility.
                  </ReactMarkdown>
                </Typography>

                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * By adopting content creation, distribution, and targeted
                    email campaigns, your organization can experience remarkable
                    growth and tap into the limitless potential of content and
                    email marketing.
                  </ReactMarkdown>
                </Typography>
                <br />
                {/* <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    * **Captivate and Engage Your Audience**: Content marketing
                    is the key to capturing the attention of your audience in a
                    world inundated with information. By crafting high-quality,
                    relevant, and compelling content, you can position your
                    organization as a thought leader and establish trust and
                    credibility. Engaging articles, blog posts, videos, and
                    infographics not only showcase your expertise but also
                    provide value to your audience, making them more likely to
                    stay connected and share your content.
                  </ReactMarkdown>
                </Typography> */}
                {/* <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
            ...
            <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              <Typography variant="h5" color="textSecondary" component="p">
                <ReactMarkdown>
                  * Get started today, and unlock the gateway to unlimited
                  success!
                </ReactMarkdown>
              </Typography>
              <Button
