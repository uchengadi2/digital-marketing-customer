...
const UpdateUserMembershipForm = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      let allData = [{}];
      api.defaults.headers.common["Authorization"] = `Bearer ${props.token}`;
      const response = await api.get(`/memberships/${props.user.membership}`);

      const workingData = response.data.data.data;

      if (allData.length > 0) {
        setMembership(workingData);
        setCategory(workingData.category);
        setConnectionAvailability(workingData.canAddMeToNetwork);
      }
      ...
      <Box>
        <FormControl variant="outlined">
          ...
          <Select
            ...
            label="Category"
            style={{ marginTop: 10, width: matchesMD ? 500 : 300 }}
            //{...input}
          >
            {renderCategoryList()}
          </Select>
  ...
  const onSubmit = (formValues) => {
    ...
    form.append(
      "headline",
      formValues.headline ? formValues.headline : membership.headline
    );
    form.append(
      "title",
      formValues.title ? formValues.title : membership.title
    );
    form.append(
      "description",
      formValues.description ? formValues.description : membership.description
    );
    form.append(
      "profession",
      formValues.profession ? formValues.profession : membership.profession
    );
    form.append(
      "qualification",
    ...
    form.append(
      "experiences",
      formValues.experiences ? formValues.experiences : membership.experiences
    );
    form.append(
      "achievements",
    ...
    form.append("bio", formValues.bio ? formValues.bio : membership.bio);
    form.append(
      "website",
      formValues.website ? formValues.website : membership.website
    );
    form.append(
      "facebookPage",
      formValues.facebookPage
        ? formValues.facebookPage
        : membership.facebookPage
    );
    form.append(
      "instagramPage",
      formValues.instagramPage
        ? formValues.instagramPage
        : membership.instagramPage
    );
    form.append(
      "youtubeChannel",
      formValues.youtubeChannel
        ? formValues.youtubeChannel
        : membership.youtubeChannel
    );
    form.append(
      "twitterHandle",
      formValues.twitterHandle
        ? formValues.twitterHandle
        : membership.twitterHandle
    );
    form.append(
      "linkedInProfile",
    ...
    form.append(
      "location",
      formValues.location ? formValues.location : membership.location
    );
    form.append(
      "canAddMeToNetwork",
      connectionAvailability
        ? connectionAvailability
        : membership.canAddMeToNetwork
    );
    form.append(
      "contactEmail",
    ...
    form.append(
      ...
      formValues.contactPhoneNumber
        ? formValues.contactPhoneNumber
        : membership.contactPhoneNumber
    );
    form.append("category", category ? category : membership.category);
    ...
    if (formValues) {
      const createForm = async () => {
        api.defaults.headers.common["Authorization"] = `Bearer ${props.token}`;
        const response = await api.patch(`/memberships/${membership.id}`, form);
        ...
        if (response.data.status === "success") {
          ...
          props.handleSuccessfulCreateSnackbar(
            `You have successfully updated your membership details!!!`
          );
          props.updateUserInfoHandler();
          props.handleUpdatedMembershipDialogForm();
          setLoading(false);
        } else {
    ...
    <Box className={classes.root}>
      <Grid item container justifyContent="center">
        <FormLabel
          ...
          component="legend"
        >
          <Typography variant="h5">Update Membership Form</Typography>
        </FormLabel>
      </Grid>
      <Box
        component="div"
        ...
        >
          <Grid item>
            <Field
              ...
              id="category"
              name="category"
              defaultValue={membership && membership.category}
              type="text"
          ...
          <Grid item>
            <Field
              ...
              name="title"
              type="text"
              defaultValue={membership && membership.title}
          ...
          <Grid item>
            <Field
              ...
              name="headline"
              type="text"
              defaultValue={membership && membership.headline}
          ...
          <Grid item>
            <Field
              ...
              name="bio"
              type="text"
              defaultValue={membership && membership.bio}
          ...
          <Grid item>
            <Field
              ...
              name="description"
              type="text"
              defaultValue={membership && membership.description}
          ...
          <Grid item>
            <Field
              ...
              name="profession"
              type="text"
              defaultValue={membership && membership.profession}
          ...
          <Grid item>
            <Field
              ...
              name="qualification"
              type="text"
              defaultValue={membership && membership.qualification}
          ...
          <Grid item>
            <Field
              ...
              name="experiences"
              type="text"
              defaultValue={membership && membership.experiences}
          ...
          <Grid item>
            <Field
              ...
              name="achievements"
              type="text"
              defaultValue={membership && membership.achievements}
          ...
          <Grid item>
            <Field
              ...
              name="website"
              type="text"
              defaultValue={membership && membership.website}
          ...
          <Grid item>
            <Field
              ...
              name="facebookPage"
              type="text"
              defaultValue={membership && membership.facebookPage}
          ...
          <Grid item>
            <Field
              ...
              name="instagramPage"
              type="text"
              defaultValue={membership && membership.instagramPage}
          ...
          <Grid item>
            <Field
              ...
              name="youtubeChannel"
              type="text"
              defaultValue={membership && membership.youtubeChannel}
          ...
          <Grid item>
            <Field
              ...
              name="twitterHandle"
              type="text"
              defaultValue={membership && membership.twitterHandle}
          ...
          <Grid item>
            <Field
              ...
              type="text"
              defaultValue={membership && membership.linkedInProfile}
          ...
          <Grid item>
            <Field
              ...
              name="contactEmail"
              type="text"
              defaultValue={membership && membership.contactEmail}
          ...
          <Grid item>
            <Field
              ...
              type="text"
              defaultValue={membership && membership.contactPhoneNumber}
