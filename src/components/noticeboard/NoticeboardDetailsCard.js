...
export default function NoticeboardDetailsCard(props) {
  ...
  const imageUrl = `${baseURL}/images/noticeboards/${props.notice.image}`;
        ...
        <Grid container direction="column" className={classes.root}>
          <Grid item container direction="row">
            ...
            <Grid item className={classes.secondRow}>
              <Box>
                ...
                <Typography variant="h5" style={{ textAlign: "center" }}>
                  <ReactMarkdown>{props.notice.title}</ReactMarkdown>
                </Typography>
                ...
                >
                  <ReactMarkdown>{props.notice.headline}</ReactMarkdown>
                </Typography>

                {props.notice.noticeRefNo !== undefined && (
                  <Typography variant="h5" color="textSecondary" component="p">
                    <span>
                      <strong>Notice Number:</strong>
                    </span>
                    <span style={{ marginLeft: 20 }}>
                      {props.notice.noticeRefNo}
                    </span>
                  </Typography>
                )}
                {props.notice.type !== undefined && (
                  <Typography variant="h5" color="textSecondary" component="p">
                    <span>
                      <strong>Notice Type:</strong>
                    </span>
                    <span style={{ marginLeft: 20 }}>{props.notice.type}</span>
                  </Typography>
                )}
              </Box>
            </Grid>
            <Grid item className={classes.thirdRow}>
              <Box>
                <Typography>
                  <strong style={{ fontSize: 15 }}>Sponsor:</strong>
                </Typography>
                <Typography
                  variant="h5"
                  style={{
                ...
                >
                  <ReactMarkdown>{props.notice.sponsor}</ReactMarkdown>
                </Typography>
                {props.notice.targetAudience !== undefined && (
                  <Typography
                    variant="h5"
                    style={{
                      color: "black",
                  ...
                  >
                    ...
                    <ReactMarkdown>{props.notice.targetAudience}</ReactMarkdown>
                  </Typography>
                )}
              </Box>
            </Grid>
          ...
          <Grid item className={classes.thirdColumn}>
            <Box>
              ...
              >
                <ReactMarkdown>{props.notice.description}</ReactMarkdown>
              </Typography>
            </Box>
          </Grid>
          <Grid
          ...
          <Grid item className={classes.thirdColumn}>
            <Card>
              <CardMedia
                ...
                alt={props.notice.title}
                height="140"
                src={`https://www.youtube.com/embed/${props.notice.video}`}
                //allow="autoPlay"
          ...
          <Grid item container direction="column">
            ...
            <Grid item className={classes.secondRowMobile}>
              <Box>
                ...
                {props.notice.projectRefNo !== "undefined" && (
                  <Typography
                    variant="h5"
                  ...
                  >
                    ...
                    {props.notice.projectRefNo}
                  </Typography>
                )}
                {props.notice.status !== undefined && (
                  <Typography
                    variant="h5"
                    style={{ color: "black", fontSize: 15 }}
                  >
                ...
                {props.notice.duration !== undefined && (
                  <Typography
                    variant="h5"
                    style={{ color: "black", fontSize: 15 }}
                  >
            ...
            <Grid item className={classes.thirdRowMobile}>
              <Box>
                {props.notice.sponsor !== undefined && (
                  <Typography
                    variant="h5"
                    style={{ color: "black", fontSize: 15 }}
                  >
                ...
                {props.notice.beneficiary !== undefined && (
                  <Typography
                    variant="h5"
                    style={{ color: "black", fontSize: 15 }}
                  >
                    ...
                    <ReactMarkdown>{props.notice.beneficiary}</ReactMarkdown>
                  </Typography>
                )}
                {props.notice.contactPersonDetails !== undefined && (
                  <Typography
                    variant="h5"
                    style={{ color: "black", fontSize: 15 }}
                  >
                    ...
                    <ReactMarkdown>
                      {props.notice.contactPersonDetails}
                    </ReactMarkdown>
                  </Typography>
                )}
              </Box>
