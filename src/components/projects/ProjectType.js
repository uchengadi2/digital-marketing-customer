...
export default function ProjectType(props) {
  ...
  const changeProjectHandler = (event) => {
    ...
    props.updateProjectHandler(event.target.value);
  };
      ...
      <Box>
        <FormControl variant="outlined" className={classes.accountType}>
          ...
          >
            ...
            <MenuItem value={"yet-to-start"}>Yet To Start Projects</MenuItem>
            <MenuItem value={"on-going"}>Ongoing Projects</MenuItem>
            <MenuItem value={"completed"}>Completed Projects</MenuItem>
            <MenuItem value={"cancel"}>Cancelled Projects</MenuItem>
            <MenuItem value={"suspended"}>Suspended Projects</MenuItem>
          </Select>
          <FormHelperText>Choose Project Status</FormHelperText>
        </FormControl>
      </Box>
    );
  };
